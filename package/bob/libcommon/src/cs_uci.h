...
#define PKG_FILE_PATH(id) \
 ((id == PKG_SYSTEM_STATUS) ? DEFAULT_UCI_STATUS_PATH : \
  ...
  (id == PKG_DHCP_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_DROPBEAR_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_FSTAB_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_NETWORK_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_SYSTEM_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_TTY_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_CSFW_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_TIMER_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_PRODUCT_CONFIG) ? ETC_PATH : \
  (id == PKG_WIRELESS_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_QOS_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_WEBR_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_DDNS_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_CRON_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_CLOUDUPDATE_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_SHADOWSOCKS_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_PPTPD_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_L2TPD_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_OPENVPND_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_PPP_USER_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_PRODUCT_ROM) ? ROM_ETC_PATH : \
  (id == PKG_PORTAL_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_VENDOR_INFO) ? UCI_CUSTOM_INFO_PATH : \
  (id == PKG_SMS_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_IPSEC_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_WIFIDOG_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_PORTALAUTH_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
  (id == PKG_CLOUDAC_CONFIG) ? DEFAULT_UCI_CONFIG_PATH : \
